...
export class TopicApi {
     ...
     */
    public produceMessageToTopic(topicName: string, records: models.ProduceMessages, extraHttpRequestParams?: any): Observable<models.OffsetWithAvroSchema> {
     ...
     * @param topicName Name of the topic to get metadata about
     */
    public getTopicMetadataWithHttpInfo(topicName: string, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/topics/${topic_name}`;
     ...
     * @param records A list of records to produce to the topic.
     */
    public produceMessageToTopicWithHttpInfo(topicName: string, records: models.ProduceMessages, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/topics/${topic_name}`;
